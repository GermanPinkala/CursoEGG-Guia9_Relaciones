...
public class Juego {
    ...
    public ArrayList<Jugador> cargarJugadores() {
        ...
        System.out.print("Ingrese la cantidad de participantes, entre 1 y 6: ");
    ...
    public Jugador ronda() {
        for (Jugador jugador : this.jugadores) {
            System.out.println("");
            System.out.println("El " + jugador.getNombre() + " tiene el revolver de agua.");
    ...
    public void partida() {
        ...
        System.out.println("¡¡El " + jugadorMojado.getNombre() + " ha sido MOJADO!!");
    }
